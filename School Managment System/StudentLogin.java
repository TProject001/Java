	...
	private void initialize() {
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(StudentDB.valid(sid, SecurePassword.hash256(pwd) )) {  //StudentId.contains("student") && pwd.contains("12")
			//		System.out.println(name+ " "+ pwd);
					JOptionPane.showMessageDialog(StudentLogin.this,"Login successfully!");
					StudentPage.main(sid);
					frame.dispose();
				}
				else {
					//JOptionPane.showMessageDialog it required extend from JFrame
					JOptionPane.showMessageDialog(StudentLogin.this, "Sorry, Invalid Login Credential!","Login Error!", JOptionPane.ERROR_MESSAGE);
